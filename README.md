...
Значок в трее: круг из двух половин. Слева провайдер (сайты провайдера), справа VPN. Двойной щелчок открывает окно с таблицей узлов, задержками и причинами сбоев.
