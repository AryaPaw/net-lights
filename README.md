...
Трей-приложение для Windows 11. Проверяет HTTPS HEAD контрольных адресов: это не весь интернет и не UDP/QUIC. Программа не меняет Мир, DNS, маршруты и сертификаты.

Значок в трее: круг из двух половин. Слева провайдер (сайты провайдера), справа мир. Двойной щелчок открывает окно с таблицей узлов, задержками и причинами сбоев.
...
Пауза в меню значка красит обе половины в стальной синий.
...
Установленная копия ждёт сеть, проверяет GitHub Releases, качает Setup, ставит его тихим Inno и снова запускается в трей. Это можно выключить во вкладке «Параметры».
