...
Пауза в меню значка красит обе половины в синий. Программа ничего не меняет в DNS, маршрутах и сертификатах.
...
После установки в трее появляется значок, программа запускается вместе с Windows. Окно само не открывается: его открывают одним щелчком по значку или пунктом меню. Крестик прячет окно в трей. Выход — из меню значка.
