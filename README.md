...
Установленная копия ждёт сеть, проверяет GitHub Releases, качает Setup и ставит его тихим Inno, затем сама выходит. Это можно выключить во вкладке «Параметры».
