...
Tray-монитор HTTPS-доступности двух пулов адресов: Провайдер (слева) и Мир (справа). Мир на роутере принимается как данность. Программа не настраивает Мир, DNS, маршруты и сертификаты Windows.
