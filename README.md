...
Опрашивает контрольные адреса по HTTPS HEAD. DNS, маршруты и сертификаты не трогает. Серый цвет значит, что свежих
данных ещё нет.
...
Выход только из меню значка. Пауза красит обе половины в синий.
