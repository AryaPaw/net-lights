...
internal sealed class StatusForm : Form
{
    ...
    public void Bind(MonitorSnapshot snapshot)
    {
        ...
        _ruBadge.SetGroup("РФ", DiagnosticExport.Label(snapshot.Ru.Availability), true);
    ...
    private Panel BuildHeader()
    {
        ...
        var subtitle = new Label
        {
            ...
            Text = "HTTPS HEAD контрольных адресов: РФ слева, VPN справа. Это не весь интернет и не UDP/QUIC.",
            Font = UiTheme.Body,
        ...
        _ruBadge.SetGroup("РФ", "нет данных", true);
