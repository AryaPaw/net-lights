...
internal sealed class StatusForm : Form
{
    ...
    public void Bind(MonitorSnapshot snapshot)
    {
        ...
        string title = $"Net Lights - РФ: {DiagnosticExport.Label(snapshot.Ru.Availability)}, VPN: {DiagnosticExport.Label(snapshot.Vpn.Availability)}";
        string summary = $"РФ: {DiagnosticExport.Label(snapshot.Ru.Availability)}  |  VPN: {DiagnosticExport.Label(snapshot.Vpn.Availability)}";
