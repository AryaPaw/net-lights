...
internal sealed class NetLightsContext : ApplicationContext
{
    ...
    public NetLightsContext()
    {
        ...
        _icon = new NotifyIcon
        {
            ...
            Icon = _renderer.Get(_snapshot.Ru.Availability, _snapshot.World.Availability, 16)
        };
    ...
    {
        _snapshot = snapshot;
        Icon icon = _renderer.Get(snapshot.Ru.Availability, snapshot.World.Availability, 16);
